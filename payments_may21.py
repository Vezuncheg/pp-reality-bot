...
PLANS = {
    "base":     {"name": "Стартовый пинок",    "amount": 5300,  "club": False},
    "extended": {"name": "Полное погружение",   "amount": 7900,  "club": True},
    "personal": {"name": "Иван лично со мной", "amount": 21200, "club": True},
}
