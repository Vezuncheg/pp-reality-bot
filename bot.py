...
async def schedule_dojim(uid, context):
    ...
    async def block1(ctx):
        ...
        await ctx.bot.send_message(uid,
            ...
            "в разных залах и странах. И вот что заметил: почти все рано или поздно предлагают "
            "перейти на анаболики — им важно сделать из тебя кейс. "
            "При этом мало кто думает о реальном здоровье и долголетии.\n\n"
            ...
            "они торчат по двенадцать часов в зале, питание из контейнеров, никаких ресторанов. "
